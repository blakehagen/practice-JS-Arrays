...
function reverseOtherWay(letters){
  var arr = letters.reverse();
...
function deleteObj(devMountainEmployees){
...
deleteObj(devMountainEmployees);
...
var user4 = {
    name: "Kenz Hagen",
    email: "kenz@email.com",
    password: "qwerty",
    username: "kzh"
};

users.push(users1, users2, users3, users4);
